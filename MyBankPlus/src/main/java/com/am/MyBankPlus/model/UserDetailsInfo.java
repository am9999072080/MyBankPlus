...
public class UserDetailsInfo implements UserDetails {
    ...
    public UserDetailsInfo(Long id, String firstName, String lastName, String middleName, String phoneNumber, LocalDate dateOfBirth, String email, String password, Card card, Collection<?
